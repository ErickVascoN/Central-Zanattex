...
coluna de Status/Corte (quem quiser isso usa o dashboard de Programação ou
o relatório completo da página de Relatórios). Reusa a casca visual de
...
def gerar_pdf_programacao(*, semana_label: str, periodo_label: str, gerado_em: str,
